    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <h4 className="text-lg font-medium text-black mb-4 flex items-center">
          {" "}
          <Calendar className="h-5 w-5 mr-2" /> Google Calendar Entegrasyonu{" "}
        </h4>{" "}
      ...
      <div>
        ...
        <h4 className="text-lg font-medium text-black mb-4 flex items-center">
          {" "}
          <Globe className="h-5 w-5 mr-2" /> Outlook Entegrasyonu{" "}
        </h4>{" "}
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          {" "}
          <div className="flex items-center justify-between mb-4">
      ...
      <div>
        ...
        <h4 className="text-lg font-medium text-black mb-4 flex items-center">
          {" "}
          <Shield className="h-5 w-5 mr-2" /> Rezervasyon Ayarları{" "}
        </h4>{" "}
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          {" "}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {" "}
                Rezervasyon Öncesi Buffer (Dakika){" "}
              </label>{" "}
              <input
                type="number"
                min="0"
            ...
            <div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {" "}
                Rezervasyon Sonrası Buffer (Dakika){" "}
              </label>{" "}
              <input
                type="number"
                min="0"
