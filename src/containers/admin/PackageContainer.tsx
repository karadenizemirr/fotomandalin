...
const packageCreateSchema = z.object({
  ...
  categoryId: z.string().min(1, "Kategori seçimi zorunludur"), // Make it required with a clear message
});
...
export default function PackageContainer() {
      ...
      if (imageUrl) {
        try {
          ...
          addToast({
            title: "Hata",
            message:
              "Paket görseli URL'i geçerli değil. Lütfen tekrar yükleyin.",
            type: "error",
          });
          return;
        }
  ...
  const getDefaultValues = () => {
    if (editingPackage) {
      console.log(
        "DEBUG: Getting default values for editingPackage:",
        editingPackage
      );
      return {
        ...
        metaTitle: editingPackage.metaTitle || "",
        metaDescription: editingPackage.metaDescription || "",
    ...
    return {
      ...
      metaTitle: "",
      metaDescription: "",
      categoryId: categories?.items?.[0]?.id || "", // Use first available category as default
    };
  };
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: (record: PackageTableData) => {
        console.log("DEBUG: Edit button clicked for package:", record);
    ...
    <div className="space-y-6">
      ...
      >
        <Form
          ...
          onSubmit={(data) => {
            console.log("DEBUG: Form onSubmit called with data:", data);
            console.log("DEBUG: Is editing package:", !!editingPackage);
